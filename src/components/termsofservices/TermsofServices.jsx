        ...
        <div className="container">
          <div className="about-topic">
            ...
            <p>
              ...
              as “Content”). Your access to and use of the Services is
          ...
          <PageImageBG />
            ...
            <p>
              ...
              other users of our Services (go to the account settings page to
            ...
            <p>
              ...
              with Tackgram and are not a person barred from receiving services
              under the laws of the United States or other applicable
              jurisdiction. You may use the Services only in compliance with
            ...
            <p>
              {" "}
              The Services that Tackgram provides are always evolving and the
              form and nature of the Services that Tackgram provides may change
              from time to time without prior notice to you. In addition,
              Tackgram may stop (permanently or temporarily) providing the
          ...
          <div className="about-sub-topic">
            <h4>Privacy</h4>
            <p>
              Any information that you provide to Tackgram is subject to our
          ...
          <div className="about-sub-topic">
            ...
            <p>
              ...
              and symbols) with your account. Tackgram cannot and will not be
          ...
          <div className="about-sub-topic">
            <h4>Tackgram Vision:</h4>
            <p>
              Our vision is to be the first choice for getting daily trending
              updates and have the best internet-based community. Tackgram’s
              plan is to reach the largest daily social media audience. By
              reaching this audience we feel ensured we can defend and respect
              the user's voice. Why? Because we believe in free expression and
              every voice has the power to impact the world.
            </p>
          </div>
          ...
          <div className="about-sub-topic">
            ...
            <p>
              ...
              deceptive. Under no circumstances will Tackgram be liable in any
          ...
          <div className="about-sub-topic">
            ...
            <p>
              ...
              or distribute it over computer networks and in various media
              and/or make changes to your Content as are necessary to conform
              and adapt that Content to any requirements or limitations of any
              networks, devices, services or media.
            </p>
            <p>
              {" "}
              You are responsible for your use of the Services, for any Content
              you provide, and for any consequences thereof, including the use
              of your Content by other users. Tackgram will not be responsible
              or liable for any use of your Content by Tackgram in accordance
              with these Terms. You represent and warrant that you have all the
              rights, power and authority necessary to grant the rights granted
              herein to any Content that you submit.
            </p>

            <p>
              Tackgram gives you a personal, worldwide, royalty-free,
              non-assignable and non-exclusive license to use the software that
              is provided to you by Tackgram as part of the Services. This
              license is for the sole purpose of enabling you to use and enjoy
              the benefit of the Services as provided by Tackgram, in the manner
              permitted by these Terms.
            </p>
          </div>

          <div className="about-sub-topic">
            <h4>Tackgram Rights</h4>
            <p>
              All right, title, and interest in and to the Services (excluding
              Content provided by users) are and will remain the exclusive
              property of Tackgram and its licensors. The Services are protected
              by copyright, trademark, and other laws of both the United States
              and foreign countries. Nothing in the Terms gives you a right to
              use the Tackgram name or any of the Tackgram trademarks, logos,
              domain names, and other distinctive brand features. Any feedback,
              comments, or suggestions you may provide regarding Tackgram, or
          ...
          <div className="about-sub-topic">
            <h4>Restrictions on Content and Use of the Services</h4>
            <p>
              We reserve the right at all times (but will not have an
              obligation) to remove or refuse to distribute any Content on the
              Services and to terminate users or reclaim usernames. Please
              review the Tackgram Rules (which are part of these Terms) to
              better understand what is prohibited on the Service. We also
              ...
              request, (ii) enforce the Terms, including investigation of
            ...
            <p>
              ...
              Services, Tackgram’s computer systems, or the technical delivery
              systems of Tackgram’s providers; (ii) probe, scan, or test the
              ...
              published interfaces that are provided by Tackgram (and only
              pursuant to those terms and conditions), unless you have been
              specifically allowed to do so in a separate agreement with
              Tackgram (NOTE: crawling the Services is permissible if done in
              accordance with the provisions of the robots.txt file, however,
              scraping the Services without the prior consent of Tackgram is
          ...
          <div className="about-sub-topic">
            ...
            <p>
              Tackgram respects the intellectual property rights of others and
            ...
            <p>
              ...
              circumstances, Tackgram will also terminate a user’s account if
          ...
          <div className="about-sub-topic">
            ...
            <p>
              ...
              the foregoing, Tackgram disclaims any warranties, express or
              implied, of merchantability, fitness for a particular purpose, or
              non-infringement. We make no warranty and disclaim all
              ...
              or any content thereon. Tackgram will not be responsible or liable
              ...
              content. You also agree that Tackgram has no responsibility or
              ...
              written, obtained from Tackgram or through the services, will
          ...
          <div className="about-sub-topic">
            <h4>Links</h4>
            <p>
              To the maximum extent permitted by applicable law, Tackgram will
              not be liable for any direct, indirect, incidental, special,
              consequential or punitive damages, including without limitation,
              loss of profits, data, use, good-will, or other intangible losses,
              ...
              party on the services, including without limitation, any
              ...
              negligence) or any other legal theory, whether or not Tackgram has
          ...
          <div className="about-sub-topic">
            ...
            <p>
              The failure of Tackgram to enforce any right or provision of these
              Terms will not be deemed a waiver of such right or provision. In
              the event that any provision of these Terms is held to be invalid
          ...
          <div className="about-sub-topic">
            ...
            <p>
              ...
              with the Services will be brought solely in Cincinnati, Ohio, and
              you consent to the jurisdiction of and venue in such courts and
              waive any objection as to inconvenient forum. If you are accepting
              these Terms on behalf of a United States federal government entity
              that is legally unable to accept the controlling law, jurisdiction
              or venue clauses above, then those clauses do not apply to you but
              instead these Terms and any action related thereto will be will be
          ...
          <div className="about-sub-topic">
            ...
            <p>
              These Terms, the Tackgram Rules and our Privacy Policy are the
              entire and exclusive agreement between Tackgram, Inc and you
              regarding the Services (excluding any services for which you have
              a separate agreement with Tackgram that is explicitly in addition
